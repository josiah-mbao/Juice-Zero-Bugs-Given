...
impl CharacterType {
    pub fn from_boss_type(boss_type: crate::game_state::BossType) -> Self {
        match boss_type {
            crate::game_state::BossType::NullPointer => CharacterType::Zombie,
            crate::game_state::BossType::UndefinedBehavior => CharacterType::Adventurer,
            crate::game_state::BossType::DataRace => CharacterType::Female,
            crate::game_state::BossType::UseAfterFree => CharacterType::Soldier,
            crate::game_state::BossType::BufferOverflow => CharacterType::Player, // Use player as alternate boss
        }
    }
}
            ...
            commands.spawn((
                AudioBundle {
                    ...
                    settings: PlaybackSettings {
                        ...
                        volume: Volume::new(10.0), // Increased volume significantly
                        ..default()
                    },
                },
                MenuMusic,
